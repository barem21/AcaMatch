...
function ReportReview() {
  ...
  const ReportReviewResult = async () => {
    try {
      const res = await axios.get(`/api/reports/getReviewList`);
      setReportReviewList(res.data.resultData);
    ...
    <div className="flex gap-5 w-full justify-center align-top">
      <div className="w-full">
        ...
        <div className="board-wrap">
          ...
          {reportReviewList?.map((item, index) => (
            <div
            ...
            >
              ...
              <div className="flex items-center justify-start text-center min-w-60">
                {item.comment}
              </div>
